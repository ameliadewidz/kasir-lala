...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="main--content">
                ...
                <div class="card--wrapper">
                    <div class="container">
                        <div class="box form-box">
                            <form method="GET">
                                <div class="field input">
                                    ...
                                    <select name="produkID" id="produkID">                                            
                                        <option value="">{{ isset ($p_detail) ? $p_detail->namaProduk : 'Product Code'}}</option>
                                            @foreach($produk as $row)
                                                <option value="{{ $row->produkID }}">{{ $row->produkID.' - '.$row->namaProduk }}</option>
                                            @endforeach
                                    </select>
                            ...
                            <form action="{{ route('insert-detailtransaction') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="field input">
                                    ...
                                    <input type="text" name="detailID" id="detailID" value="{{ old('detailID') }}">
                                </div>
                                ...
                                <div class="field input">
                                    ...
                                    <select name="penjualanID" id="penjualanID">
                                            @foreach($penjualan as $row)
                                                <option value="{{ $row->penjualanID }}">{{ $row->penjualanID }}</option>
                                            @endforeach
                                    </select>
                                </div>
            ...
            {{-- tabel --}}
            {{-- <div class="card--container">
                <h3 class="main--title">Transaction Status</h3>
                <div class="card--wrapper">
                    <div class="container">
                        <table>
                            <thead>
